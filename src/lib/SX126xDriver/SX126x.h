...
public:
    ...
    void SetMode(SX126x_RadioOPmodes mode, SX12XX_Radio_Number_t radioNumber);
    void SetTxIdleMode() { SetMode(SX126x_OPMODE_STANDBY, SX12XX_Radio_All); } // set Idle mode used when switching from RX to TX
...
private:
    ...
    SX126x_Bandwidth currBW;
    SX126x_SpreadingFactor currSF;
    SX126x_CodingRate currCR;
    SX126x_RadioOPmodes currOpmode;
    SX126x_ModulationModes ModFSKorLoRa;
